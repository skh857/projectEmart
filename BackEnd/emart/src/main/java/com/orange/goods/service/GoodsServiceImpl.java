...
public class GoodsServiceImpl implements GoodsService {
    ...
    @Autowired
    private GoodsDAO goodsDAO; // GoodsDAO와 연결되는 DAO 인터페이스
    ...
    @Override
    public List<GoodsDTO> getAllGoods() throws Exception{
        return goodsDAO.selectAllGoods(); // DAO를 통해 모든 상품을 조회
    }

    @Override
    public GoodsDTO getGoodsByNo(int g_no) throws Exception{
        return goodsDAO.selectGoodsByNo(g_no); // DAO를 통해 상품 번호로 상품 정보를 조회
    }
