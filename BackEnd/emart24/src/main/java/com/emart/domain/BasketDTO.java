...
public class BasketDTO {
	...
	// 멤버 변수
	private int b_no;	// 장바구니 상품 번호
    private String b_image;	// 장바구니 상품 사진
    private String b_name;	// 장바구니 상품 이름
    private int b_price;	// 장바구니 상품 가격
    private int b_purchase_cnt;	// 장바구니 상품 구매 개수
    private int b_purchase_price;	// 장바구니 상품 구매 가격
