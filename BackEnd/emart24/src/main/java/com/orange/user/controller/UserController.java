...
public class UserController {
	...
	public String success(UserDTO userDTO, Model m) throws Exception {
		...
		// 메세지 및 경로 Model에 저장
		m.addAttribute("msg", "회원 가입이 완료되었습니다.");
		m.addAttribute("url", "/emart");
	...
	// 계정 삭제
	@PostMapping("/remove")
	public String remove(UserDTO userDTO, Model m, HttpSession session) {
